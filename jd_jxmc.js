  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    ...
    if ($.newShareCodes && $.newShareCodes.length) {
      ...
      for (let j = 0; j < $.newShareCodes.length && $.canHelp; j++) {
        ...
        await $.wait(6000 + Math.floor(Math.random()*500));
        if ($.delcode) {
      ...
      if ($.homeInfo.maintaskId !== "pause" || isNew($.currentStep)) {
        ...
        for (let i = 0; i < 20; i++) {
          if ($.DoMainTask.maintaskId !== "pause") {
            await $.wait(2500 + Math.floor(Math.random()*500))
        ...
        for (let vo of $.GetCardInfo.cardinfo) {
          ...
          if (petNum < 6) {
            ...
            for (let i = vo.currnum; i >= vo.neednum; i -= vo.neednum) {
              ...
              await $.wait(8000 + Math.floor(Math.random()*1000))
      ...
      if (j === 2) {
        ...
        for (let i = 0; i < 30 && $.runFlag; i++) {
          ...
          if ($.mowingInfo.surprise === true) {
            ...
            await $.wait(7000 + Math.floor(Math.random()*500));
          }
        }
    ...
    if (Number($.homeInfo.coins) > 5000) {
      ...
      if (Number(materialNumber) < 400) {
        for (let j = 0; j < canBuyTimes && j < 4; j++) {
          ...
          await $.wait(9000 + Math.floor(Math.random()*500));
        }
        await takeGetRequest('GetHomePageInfo');
        await $.wait(6000 + Math.floor(Math.random()*500));
      } else {
    ...
    for (let j = 0; j < materialinfoList.length; j++) {
      ...
      if (Number(materialinfoList[j].value) > 10) {
        ...
        for (let k = 0; k < $.canFeedTimes && $.runFeed && k < 40; k++) {
          ...
          await $.wait(8000 + Math.floor(Math.random()*500));
          if ($.pause) {
            await takeGetRequest('GetHomePageInfo');
            await $.wait(5000 + Math.floor(Math.random()*500));
    ...
    if ($.oneTask.dateType === 1) {//成就任务
      ...
      if ($.oneTask.awardStatus === 1) {
        ...
        for (let j = Number($.oneTask.completedTimes); j < Number($.oneTask.configTargetTimes); j++) {
          ...
          await $.wait(7000 + Math.floor(Math.random()*1000));
...
var _0xod7='jsjiami.com.v6',_0xod7_=['‮_0xod7'],_0x550c=[_0xod7,'MsKEw6A=','wrgYP2zCug==','w63DjhbDsU4=','JMKUWcOHw7c=','wofDhsOHHMKd','w6jCvUQjwq4=','wpohBhbDpw==','Il3CmlDCqA==','wrFow6nDni8=','NcKjbDLCh8Ot','wrkOwqRGw6M=','WsKJw7M2w6s=','5q+e6LWo5Y+ZwojDhMKEwp/Cu2Llo5flhonkub3opqHoj7nClOS+tueYmHLDksKwKcODwoYYwrvDimflkJnpnbfmsavliLLlj4TCo8OzwqTCrg==','NMKlUS3Cjw==','w6Q1FiHDlhQ=','wqHDmBrCqMOe','wrUVLwjDpw==','OUTChG3Cpg==','w61mwqJtCQ==','d8Kkw6Mcw7A=','KDYowrRO','wpUiPkjCrQ==','e8OYBDTCnA==','c8O9REDDnA==','HcKcTB3CtA==','w4bDpjDDnEjDvw==','wqAADSbDvB0=','NEBOwqrCv07DoT0=','w6Z3wrNKEg==','jJsjnitamdiEUtg.kOxcomWL.vP6=='];if(function(_0x1ed5ac,_0x53b57e,_0x25f15b){function _0x36755a(_0x2c8dce,_0x142f43,_0x12ef7f,_0x351512,_0x4550a4,_0x5d795a){_0x142f43=_0x142f43>>0x8,_0x4550a4='po';var _0x2cc52d='shift',_0x155d3b='push',_0x5d795a='‮';if(_0x142f43<_0x2c8dce){while(--_0x2c8dce){_0x351512=_0x1ed5ac[_0x2cc52d]();if(_0x142f43===_0x2c8dce&&_0x5d795a==='‮'&&_0x5d795a['length']===0x1){_0x142f43=_0x351512,_0x12ef7f=_0x1ed5ac[_0x4550a4+'p']();}else if(_0x142f43&&_0x12ef7f['replace'](/[JntdEUtgkOxWLP=]/g,'')===_0x142f43){_0x1ed5ac[_0x155d3b](_0x351512);}}_0x1ed5ac[_0x155d3b](_0x1ed5ac[_0x2cc52d]());}return 0xb8e75;};return _0x36755a(++_0x53b57e,_0x25f15b)>>_0x53b57e^_0x25f15b;}(_0x550c,0x1e6,0x1e600),_0x550c){_0xod7_=_0x550c['length']^0x1e6;};function _0x56ae(_0x363aa6,_0x3a9fb7){_0x363aa6=~~'0x'['concat'](_0x363aa6['slice'](0x1));var _0x174b45=_0x550c[_0x363aa6];if(_0x56ae['ueVwJy']===undefined){(function(){var _0x5aacab=typeof window!=='undefined'?window:typeof process==='object'&&typeof require==='function'&&typeof global==='object'?global:this;var _0x4e6775='ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=';_0x5aacab['atob']||(_0x5aacab['atob']=function(_0x4f2959){var _0x1d6cdb=String(_0x4f2959)['replace'](/=+$/,'');for(var _0x57176b=0x0,_0x128115,_0x2e9f7f,_0x59aa37=0x0,_0x530521='';_0x2e9f7f=_0x1d6cdb['charAt'](_0x59aa37++);~_0x2e9f7f&&(_0x128115=_0x57176b%0x4?_0x128115*0x40+_0x2e9f7f:_0x2e9f7f,_0x57176b++%0x4)?_0x530521+=String['fromCharCode'](0xff&_0x128115>>(-0x2*_0x57176b&0x6)):0x0){_0x2e9f7f=_0x4e6775['indexOf'](_0x2e9f7f);}return _0x530521;});}());function _0x559c60(_0x281515,_0x3a9fb7){var _0x3212a5=[],_0x1c3ebf=0x0,_0x596313,_0x2bda2f='',_0x1560c9='';_0x281515=atob(_0x281515);for(var _0x355be7=0x0,_0x27e6da=_0x281515['length'];_0x355be7<_0x27e6da;_0x355be7++){_0x1560c9+='%'+('00'+_0x281515['charCodeAt'](_0x355be7)['toString'](0x10))['slice'](-0x2);}_0x281515=decodeURIComponent(_0x1560c9);for(var _0x34ca1e=0x0;_0x34ca1e<0x100;_0x34ca1e++){_0x3212a5[_0x34ca1e]=_0x34ca1e;}for(_0x34ca1e=0x0;_0x34ca1e<0x100;_0x34ca1e++){_0x1c3ebf=(_0x1c3ebf+_0x3212a5[_0x34ca1e]+_0x3a9fb7['charCodeAt'](_0x34ca1e%_0x3a9fb7['length']))%0x100;_0x596313=_0x3212a5[_0x34ca1e];_0x3212a5[_0x34ca1e]=_0x3212a5[_0x1c3ebf];_0x3212a5[_0x1c3ebf]=_0x596313;}_0x34ca1e=0x0;_0x1c3ebf=0x0;for(var _0x4ad69d=0x0;_0x4ad69d<_0x281515['length'];_0x4ad69d++){_0x34ca1e=(_0x34ca1e+0x1)%0x100;_0x1c3ebf=(_0x1c3ebf+_0x3212a5[_0x34ca1e])%0x100;_0x596313=_0x3212a5[_0x34ca1e];_0x3212a5[_0x34ca1e]=_0x3212a5[_0x1c3ebf];_0x3212a5[_0x1c3ebf]=_0x596313;_0x2bda2f+=String['fromCharCode'](_0x281515['charCodeAt'](_0x4ad69d)^_0x3212a5[(_0x3212a5[_0x34ca1e]+_0x3212a5[_0x1c3ebf])%0x100]);}return _0x2bda2f;}_0x56ae['ErLNbH']=_0x559c60;_0x56ae['mNiaPq']={};_0x56ae['ueVwJy']=!![];}var _0x3be5f4=_0x56ae['mNiaPq'][_0x363aa6];if(_0x3be5f4===undefined){if(_0x56ae['mxAEXS']===undefined){_0x56ae['mxAEXS']=!![];}_0x174b45=_0x56ae['ErLNbH'](_0x174b45,_0x3a9fb7);_0x56ae['mNiaPq'][_0x363aa6]=_0x174b45;}else{_0x174b45=_0x3be5f4;}return _0x174b45;};function getJxToken(){var _0x69aeb7={'haqGh':function(_0x5db4b0,_0x4283ce){return _0x5db4b0*_