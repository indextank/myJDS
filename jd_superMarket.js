...
async function barGain() {
  //euper
  let res = await getAuthorShareCode2('https://raw.https://raw.githubusercontent.com/indextank/myJDS/master/shareCodes/jd_barGain.json')
  // if (!res) {
...
async function bigWinner() {
  let res = await getAuthorShareCode2('https://raw.https://raw.githubusercontent.com/indextank/myJDS/master/shareCodes/bigWinner.json')
  // if (!res) {
