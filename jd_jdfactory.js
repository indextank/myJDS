...
[task_local]
#东东工厂
10 0 * * * jd_jdfactory.js, tag=东东工厂, enabled=true

================Loon==============
[Script]
cron "10 0 * * *" jd_jdfactory.js,tag=东东工厂

===============Surge=================
东东工厂 = type=cron,cronexp="10 0 * * *",wake-system=1,timeout=3600,jd_jdfactory.js

============小火箭=========
东东工厂 = type=cron,jd_jdfactory.js, cronexpr="10 0 * * *", timeout=3600, enable=true
 */
const $ = new Env('东东工厂');
