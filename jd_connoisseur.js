...
[task_local]
#内容鉴赏官
07 0,9 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_connoisseur.js, tag=内容鉴赏官, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "07 0,9 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_connoisseur.js,tag=内容鉴赏官

===============Surge=================
内容鉴赏官 = type=cron,cronexp="07 0,9 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_connoisseur.js

============小火箭=========
内容鉴赏官 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_connoisseur.js, cronexpr="07 0,9 * * *", timeout=3600, enable=true
 */
const $ = new Env('内容鉴赏官');
...
!(async () => {
  ...
  // euper
  let res = await getAuthorShareCode('https://raw.githubusercontent.com/indextank/myJDS/master/shareCodes/jd_connoisseur.json')
  // if (!res) {
