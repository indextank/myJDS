/*
#City脚本配置
cron "5 17 * * *" jd_farm.js, tag:东东农场日常任务
*/
...
let message = '',
 ...
 // 保留水滴大于多少g,默认1000g;
const retainWater = $.isNode() ? (process.env.retainWater ? process.env.retainWater : 1000) : ($.getdata('retainWater') ? $.getdata('retainWater') : 1000);
