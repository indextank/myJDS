...
$.cookiesArr = []
$.innerKeyWords = [
    "幼儿园", "教程", "英语", "辅导", "培训", "体验课", "编程", "直播", "思维",
    "孩子", "小学", "宝宝", "网红", "试用", "纸尿裤", "真题", "滋补", "强身",
    "幼儿", "配方", "益生菌", "奶粉", "钥匙扣", "避孕", "纸尿裤", "教材", "家庭版",
    "减肥", "瘦肚", "瘦身", "美腿", "美瞳", "美容", "美颜", "素颜", "养颜", "眼影", "化妆", "卸妆",
    "控油", "补水", "保湿", "防晒", "护手霜", "护肤", "洗面", "纹眉", "染发", "吸水",
    "眉毛", "刮毛", "脱毛", "毛孔", "睫毛", "刮痧", "面罩", "眼线", "面膜", "脸部", "改善",
    "香水", "香膏", "香薰", "胸贴",
    "和田玉", "玉佩", "玉坠", "首饰", "银饰", "对戒", "项链", "玉镯", "水晶", "梳子", "挂件", "吊坠", "手串",
    "成人用品", "套套", "情趣", "自慰", "阳具", "飞机杯", "男士用品", "女士用品", "丝袜", "黑丝",
    "内衣", "高潮", "避孕", "乳腺", "肛塞", "肛门", "精油", "私密", "瘙痒",
    "玩具", "芭比", "娃娃", "男用", "女用", "神油", "足力健", "老年", "老人",
    "宠物", "猫", "狗", "猫粮", "饲料", "磨脚", "硅胶", "维生素", "有机肥", "过滤网",
    "脚皮", "除臭", "性感", "内裤", "跳蛋", "安全套", "龟头", "阴道", "阴部", "湿巾",
    "保护套", "保护壳", "手机壳", "钢化膜", "防窥膜", "贴膜", "支架", "电信", "移动", "联通", "上网卡", "卡槽", "卡托", "镜片",
    "清洁剂", "药剂", "农药", "药", "软膏", "乳膏", "口服液", "肚脐贴", "尖锐湿疣", "治疗", "疗效", "颗粒", "咽炎", "口腔",
    "眼镜", "短袜", "袜子", "抹布", "湿巾", "手巾", "方巾", "牙刷", "鞋垫", "鞋带", "鞋刷", "高跟鞋", "手套", "帽子",
    "戒烟", "原液", "封口", "泡网", "伐木", "盆栽", "花卉", "托盘",
    "品茗杯", "代用茶", "汤茶", "花茶", "葛根", "骨质", "豆腐干", "零食", "牛筋丸",
    "保鲜", "把手", "拖把", "衣架", "口罩", "口水", "清新口气", "收银", "沃尔夫冈"
];
$.innerKeyWords = process.env.try_filter_keyword.split(",") || $.innerKeyWords;
