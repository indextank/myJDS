...
[task_local]
#京东小魔方
31 2,14 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_mf.js, tag=京东小魔方, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "31 2,14 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_mf.js,tag=京东小魔方

===============Surge=================
京东小魔方 = type=cron,cronexp="31 2,14 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_mf.js

============小火箭=========
京东小魔方 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_mf.js, cronexpr="31 2,14 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东小魔方');
...
let uuid
//euper
$.shareCodes = [{"use": "455979050-14287437","code": "Suvh2SRkQ9VHXPRvwlv8NcNb9"},{"use": "jd_RbuUwXHBNnJR","code": "S5KkcIkxckBO_WGiKyo1o"},{"use": "lman87","code": "S4qAiHhYe"},{"use": "jd_rkylFaEIkvBL","code": "S5KkcAkVQqSKGVWOv0oV2"},{"use": "jd_7a84de20543eb","code": "S5KkcR08R8QCCIhrxkPRfJg"}]
let hotInfo = {}
if ($.isNode()) {
