...
[task_local]
#东东健康社区
5 14 * * * jd_health_help.js, tag=东东健康社区, enabled=true

=====================Loon================
[Script]
cron "5 14 * * *" jd_health_help.js, tag=东东健康社区

====================Surge================
东东健康社区 = type=cron,cronexp="5 14 * * *",wake-system=1,timeout=3600,jd_health_help.js

============小火箭=========
东东健康社区 = type=cron,jd_health_help.js, cronexpr="5 14 * * *", timeout=3600, enable=true
 */
