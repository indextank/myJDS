...
[task_local]
#jd免费水果
45 6,22 * * * jd_fruit.js, tag=东东农场, enabled=true
=========================Loon=============================
[Script]
cron "45 6,22 * * *" script-path=jd_fruit.js,tag=东东农场
=========================Surge============================
东东农场 = type=cron,cronexp="45 6,22 * * *",wake-system=1,timeout=3600,script-path=jd_fruit.js
=========================小火箭===========================
东东农场 = type=cron,script-path=jd_fruit.js, cronexpr="45 6,22 * * *", timeout=3600, enable=true
