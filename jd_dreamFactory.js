...
[task_local]
#京喜工厂
43 0,6-23/4 * * * jd_dreamFactory.js, tag=京喜工厂, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "43 0,6-23/4 * * *" script-path=jd_dreamFactory.js,tag=京喜工厂

===============Surge=================
京喜工厂 = type=cron,cronexp="43 0,6-23/4 * * *",wake-system=1,timeout=3600,script-path=jd_dreamFactory.js

============小火箭=========
京喜工厂 = type=cron,script-path=jd_dreamFactory.js, cronexpr="43 0,6-23/4 * * *", timeout=3600, enable=true
